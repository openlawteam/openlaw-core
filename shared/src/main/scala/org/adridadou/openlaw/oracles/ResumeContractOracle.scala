...
case class ResumeContractOracle(crypto:CryptoService) extends SignedActionOracle[ResumeExecutionEvent] {
...
case class ResumeExecutionEvent(signature: EthereumSignature) extends SignedActionEvent {
