...
class XHtmlAgreementPrinterSpec
  ...
  it should "handle right aligned section" in {
    ...
    val html = XHtmlAgreementPrinter(false)
      .printParagraphs(agreement.right.value.paragraphs)
      .print
    html shouldBe """<p class="align-right no-section"><strong>[[Company Name]]</strong></p>"""
  }
  ...
  it should "handle right aligned underlined section" in {
    ...
    val html = XHtmlAgreementPrinter(false)
      .printParagraphs(agreement.right.value.paragraphs)
      .print
    html shouldBe """<p class="align-right no-section"><u>[[Company Name]]</u></p>"""
  }
  ...
  it should "handle right 3/4 aligned section" in {
    ...
    val html = XHtmlAgreementPrinter(false)
      .printParagraphs(agreement.right.value.paragraphs)
      .print
    html shouldBe """<p class="align-right-three-quarters no-section"><strong>[[Company Name]]</strong></p>"""
  }
  ...
  it should "handle tables with variables in multiple rows" in {
    ...
    val html = XHtmlAgreementPrinter(true)
      .printParagraphs(agreement.right.value.paragraphs)
      .print
    html shouldBe """<div class="openlaw-paragraph paragraph-1"><p class="no-section">This is | a test.<br /><table class="markdown-table"><tr class="markdown-table-row"><th class="markdown-table-header align-left border-show">head1</th><th class="markdown-table-header align-left border-show">head2</th><th class="markdown-table-header align-left border-show">head3</th></tr><tr class="markdown-table-row"><td class="markdown-table-data align-left border-show"><span class="markdown-variable markdown-variable-var1">[[var1]]</span></td><td class="markdown-table-data align-left border-show">val12</td><td class="markdown-table-data align-left border-show">val13</td></tr><tr class="markdown-table-row"><td class="markdown-table-data align-left border-show">val21</td><td class="markdown-table-data align-left border-show">val22</td><td class="markdown-table-data align-left border-show">val23</td></tr><tr class="markdown-table-row"><td class="markdown-table-data align-left border-show"><span class="markdown-variable markdown-variable-var31">[[var31]]</span></td><td class="markdown-table-data align-left border-show">val32</td><td class="markdown-table-data align-left border-show">val33</td></tr><tr class="markdown-table-row"><td class="markdown-table-data align-left border-show">val41</td><td class="markdown-table-data align-left border-show">val42</td><td class="markdown-table-data align-left border-show">val43</td></tr></table>This is a test.</p></div>"""
  }
  ...
  it should "handle table with text with multiple words" in {
    ...
    val html = XHtmlAgreementPrinter(true)
      .printParagraphs(agreement.right.value.paragraphs)
      .print
    html shouldBe """<div class="openlaw-paragraph paragraph-1"><p class="no-section"><br /><table class="markdown-table"><tr class="markdown-table-row"><th class="markdown-table-header align-left border-show">head1</th><th class="markdown-table-header align-left border-show">head2</th></tr><tr class="markdown-table-row"><td class="markdown-table-data align-left border-show">test test</td><td class="markdown-table-data align-left border-show">test</td></tr><tr class="markdown-table-row"><td class="markdown-table-data align-left border-show">test</td><td class="markdown-table-data align-left border-show">test</td></tr></table></p></div>"""
  }
  ...
  it should "handle table with a variables with text prefixes" in {
    ...
    val html = XHtmlAgreementPrinter(true)
      .printParagraphs(agreement.right.value.paragraphs)
      .print
    html shouldBe """<div class="openlaw-paragraph paragraph-1"><p class="no-section"><br /><table class="markdown-table"><tr class="markdown-table-row"><th class="markdown-table-header align-left border-show">head1</th><th class="markdown-table-header align-left border-show">head2</th></tr><tr class="markdown-table-row"><td class="markdown-table-data align-left border-show">$<span class="markdown-variable markdown-variable-var31">[[var31]]</span></td><td class="markdown-table-data align-left border-show">test</td></tr><tr class="markdown-table-row"><td class="markdown-table-data align-left border-show">test</td><td class="markdown-table-data align-left border-show">test</td></tr></table></p></div>"""
  }
