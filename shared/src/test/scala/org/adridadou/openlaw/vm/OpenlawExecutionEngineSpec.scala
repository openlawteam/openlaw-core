 ...
 |                  other var -> var + " world")]]""".stripMargin)
    ...
    engine.execute(template, TemplateParameters("texts" -> paramValue)) match {
      case Right(result) =>
        parser.forReview(result.agreements.head) shouldBe
          """<p class="no-section">this is a test<br /><br />        </p><p class="no-section">to see if for each works<br /><br />       </p><p class="no-section"><br /><br />       </p><p class="no-section"><table class="markdown-table"><tr class="markdown-table-row"><th class="markdown-table-header align-left border-show">head1</th><th class="markdown-table-header align-left border-show">head2</th><th class="markdown-table-header align-left border-show">head3</th></tr><tr class="markdown-table-row"></tr><tr class="markdown-table-row"><td class="markdown-table-data align-left border-show">val11</td><td class="markdown-table-data align-left border-show">val12</td><td class="markdown-table-data align-left border-show">text1</td></tr><tr class="markdown-table-row"><td class="markdown-table-data align-left border-show">val11</td><td class="markdown-table-data align-left border-show">val12</td><td class="markdown-table-data align-left border-show">text2</td></tr><tr class="markdown-table-row"><td class="markdown-table-data align-left border-show">val11</td><td class="markdown-table-data align-left border-show">val12</td><td class="markdown-table-data align-left border-show">text3</td></tr></table></p>"""
      case Left(ex) =>
        ex.printStackTrace()
        fail(ex.message)
    }
  ...
  it should "be able to create a period from 2 dates" in {
    ...
    val toDate = LocalDateTime
      ...
      .withSecond(0)
      .withNano(0)
    val Right(result) = engine.execute(
      template,
      TemplateParameters(
        "from" -> DateTimeType
